<template>
    <DashboardLayout title="Supplier Details" :user="user" :navigation="navigation">
        <div class="mb-6">
            <Link :href="route('manager.suppliers.index')" class="text-kotel-sky-blue hover:text-kotel-yellow mb-4 inline-block">
                ← Back to Suppliers
            </Link>
        </div>
                <!-- Supplier Info Card -->
                ...
                <div class="bg-white shadow rounded-lg mb-6">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <Link :href="route('manager.purchases.index')" class="text-sm text-blue-600 hover:text-blue-900">
                            View All →
                        </Link>
                    </div>
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <Link :href="route('manager.suppliers.payments.index', supplier.id)" class="text-sm text-blue-600 hover:text-blue-900">
                            View All →
                        </Link>
                    </div>
                    <div class="overflow-x-auto">
