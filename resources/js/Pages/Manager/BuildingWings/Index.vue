<template>
    <DashboardLayout title="Building Wings" :user="user" :navigation="navigation">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-kotel-yellow"
                        style="color: #FFD700;">Building Wings Management</h1>
                    <p class="text-kotel-sky-blue mt-1"
                       style="color: #87CEEB;">Manage building wings and sections</p>
                </div>
                <Link :href="route('admin.building-wings.create')" 
...
const deleteWing = (wing) => {
    if (confirm(`Are you sure you want to delete ${wing.name}?`)) {
        router.delete(route('admin.building-wings.destroy', wing.id))
    }
}
</script>
