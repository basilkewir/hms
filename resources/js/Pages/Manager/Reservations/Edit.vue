    ...
    <DashboardLayout title="Edit Reservation" :user="user" :navigation="navigation">
        <div class="shadow rounded-lg p-6 mb-8" :style="{ backgroundColor: themeColors.card, borderColor: themeColors.border }">
            <div class="flex items-center justify-between mb-6">
                ...
                <Link :href="route('manager.reservations.show', reservation.id)" class="px-4 py-2 rounded-md transition-colors font-medium"
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t" :style="{ borderColor: themeColors.border }">
                    <Link :href="route('manager.reservations.show', reservation.id)" class="px-6 py-2 rounded-md font-medium"
                          :style="{ backgroundColor: themeColors.secondary, color: themeColors.textPrimary }">
                        Cancel
                    </Link>
...
const submit = () => {
    form.put(route('manager.reservations.update', props.reservation.id), { preserveScroll: true })
}
</script>
