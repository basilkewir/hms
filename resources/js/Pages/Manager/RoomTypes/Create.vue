<template>
    <DashboardLayout title="Create Room Type">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold mb-2"
                        :style="{ color: themeColors.textPrimary }">Create New Room Type</h1>
                    <p class="mt-2"
                       :style="{ color: themeColors.textSecondary }">Add a new room type to your hotel inventory.</p>
                </div>
