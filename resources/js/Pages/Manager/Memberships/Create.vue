<template>
    <DashboardLayout title="Create Membership" :user="user" :navigation="navigation">
        <!-- Header -->
        <div class="shadow rounded-lg p-6 mb-8"
             :style="{ backgroundColor: themeColors.card, borderColor: themeColors.border }">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2" :style="{ color: themeColors.textPrimary }">Create Membership</h1>
                    <p class="mt-2" :style="{ color: themeColors.textSecondary }">Add a new loyalty tier.</p>
                </div>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        {{ form.processing ? 'Creating...' : 'Create Membership' }}
                    </button>
                </div>
            </form>
        </div>
