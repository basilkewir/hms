...
const props = defineProps({
    ...
    charges: Array,
    services: Array,
    voidRouteName: { type: String, default: 'manager.folio-charges.void' },
    storeRouteName: { type: String, default: 'manager.reservations.service-charges.store' },
})

const navigation = computed(() => getNavigationForRole(props.user?.roles?.[0]?.name || 'manager'))
