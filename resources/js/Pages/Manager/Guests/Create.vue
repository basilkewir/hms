        ...
        <form @submit.prevent="createGuest" class="space-y-6">
            ...
            <div class="shadow rounded-lg p-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Middle Name</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Date of Birth</label>
                        <DatePicker v-model="form.date_of_birth" placeholder="Select date of birth" />
                        <div v-if="form.errors.date_of_birth" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.date_of_birth }}</div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Gender</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Nationality *</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Occupation</label>
            ...
            <div class="shadow rounded-lg p-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Alternative Phone</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">ZIP / Postal Code</label>
                    ...
                    <div>
                        ...
                        <input type="text" v-model="form.country" required
                               class="w-full rounded-md px-3 py-2 focus:outline-none transition-colors"
                               :style="{ backgroundColor: themeColors.background, borderColor: themeColors.border, color: themeColors.textPrimary, borderWidth: '1px', borderStyle: 'solid' }">
                        <div v-if="form.errors.country" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.country }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="shadow rounded-lg p-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">ID Type *</label>
                        ...
                        <div v-if="form.errors.id_type" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.id_type }}</div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">ID Number *</label>
                        <input type="text" v-model="form.id_number" required
                               class="w-full rounded-md px-3 py-2 focus:outline-none transition-colors"
                               :style="{ backgroundColor: themeColors.background, borderColor: themeColors.border, color: themeColors.textPrimary, borderWidth: '1px', borderStyle: 'solid' }">
                        <div v-if="form.errors.id_number" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.id_number }}</div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Issuing Authority</label>
                        <input type="text" v-model="form.id_issuing_authority"
                               class="w-full rounded-md px-3 py-2 focus:outline-none transition-colors"
                               :style="{ backgroundColor: themeColors.background, borderColor: themeColors.border, color: themeColors.textPrimary, borderWidth: '1px', borderStyle: 'solid' }">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Issue Date *</label>
                        <DatePicker v-model="form.id_issue_date" placeholder="Select issue date" :required="true" />
                        <div v-if="form.errors.id_issue_date" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.id_issue_date }}</div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Expiry Date *</label>
                        <DatePicker v-model="form.id_expiry_date" placeholder="Select expiry date" :required="true" />
                        <div v-if="form.errors.id_expiry_date" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.id_expiry_date }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="shadow rounded-lg p-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Purpose of Visit *</label>
                        ...
                        <div v-if="form.errors.purpose_of_visit" class="mt-1 text-sm" :style="{ color: themeColors.danger }">{{ form.errors.purpose_of_visit }}</div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Room Preference</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Bed Preference</label>
                    ...
                    <div class="lg:col-span-3">
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Dietary Restrictions</label>
            ...
            <div class="shadow rounded-lg p-6"
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Medical Conditions / Accessibility Needs</label>
                        <textarea v-model="form.medical_conditions" rows="2"
                                  placeholder="Any medical conditions or accessibility needs the guest has..."
                                  class="w-full rounded-md px-3 py-2 focus:outline-none transition-colors"
                                  :style="{ backgroundColor: themeColors.background, borderColor: themeColors.border, color: themeColors.textPrimary, borderWidth: '1px', borderStyle: 'solid' }"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2" :style="{ color: themeColors.textSecondary }">Internal Notes</label>
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button type="button" @click="form.is_vip = !form.is_vip"
                                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none"
                                :style="{ backgroundColor: form.is_vip ? themeColors.warning : themeColors.border }">
                            <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
                                  :class="form.is_vip ? 'translate-x-6' : 'translate-x-1'"></span>
                        </button>
                        <span class="text-sm font-medium" :style="{ color: themeColors.textPrimary }">Mark as VIP Guest</span>
                        <span v-if="form.is_vip" class="text-xs px-2 py-0.5 rounded-full font-semibold"
                              :style="{ backgroundColor: 'rgba(251,191,36,0.2)', color: themeColors.warning }">VIP</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                <button type="submit" :disabled="form.processing"
                        ...
                        :style="{ backgroundColor: themeColors.primary, color: '#ffffff', opacity: form.processing ? 0.7 : 1 }"
