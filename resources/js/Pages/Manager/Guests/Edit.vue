        ...
        <div class="bg-white shadow rounded-lg p-6 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Update guest information for {{ guest.full_name }}</p>
                </div>
                <div class="flex space-x-3">
                    <Link :href="route('manager.guests.show', guest.id)" 
...
const updateGuest = () => {
    form.put(route('manager.guests.update', props.guest.id), {
        preserveScroll: true,
    })
}
</script>
