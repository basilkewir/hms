<template>
    <DashboardLayout title="Current Guests" :user="user" :navigation="navigation">
        <div class="bg-white shadow rounded-lg p-6 mb-8">
            <h1 class="text-2xl font-bold text-gray-900">Current Guests</h1>
            <p class="text-gray-600 mt-2">Guests currently checked in</p>
        </div>

        <div class="bg-white shadow rounded-lg p-6">
            <div v-if="currentGuests && currentGuests.length > 0" class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="guest in currentGuests" :key="guest.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <Link :href="route('manager.checkout', { reservation_id: guest.reservation_id })" 
                                      class="text-orange-600 hover:text-orange-900">Check Out</Link>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div v-else class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No current guests</h3>
                <p class="mt-1 text-sm text-gray-500">There are no guests currently checked in.</p>
            </div>
        </div>
    </DashboardLayout>
</template>
