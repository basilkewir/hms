        ...
        <div class="shadow rounded-lg p-6 mb-8"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <button @click="router.visit(route('pos.purchases.index'))"
...
const editPurchaseOrder = () => {
    router.visit(route('pos.purchases.edit', props.purchaseOrder.id))
}
...
const submitReceiveOrder = () => {
    ...
    router.post(route('pos.purchases.receive', props.purchaseOrder.id), {
...
const submitPayment = () => {
    ...
    router.post(route('pos.suppliers.payments.store', props.purchaseOrder.supplier_id), {
