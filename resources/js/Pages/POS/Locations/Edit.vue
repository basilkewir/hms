<template>
    <DashboardLayout title="Edit Location" :user="user">
        <div class="max-w-2xl mx-auto">
            <div class="rounded-lg shadow-sm p-6" :style="{ backgroundColor: themeColors.card }">
                <h1 class="text-2xl font-bold mb-6" :style="{ color: themeColors.textPrimary }">Edit Location</h1>
...
const submit = () => {
    form.put(route('pos.locations.update', props.location.id))
}
</script>
