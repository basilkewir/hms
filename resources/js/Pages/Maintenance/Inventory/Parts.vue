<template>
    <DashboardLayout title="Parts & Supplies" :user="user">
        <div class="bg-white shadow rounded-lg p-6 mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Parts & Supplies</h1>
            <p class="text-gray-600 mt-2">Recent maintenance parts requests.</p>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr v-for="item in items" :key="item.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">{{ formatCategory(item.category) }}</td>
...
const formatCategory = (category) => {
    return category ? category.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) : 'N/A'
}
