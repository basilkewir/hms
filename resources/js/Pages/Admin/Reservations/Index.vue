<template>
    <DashboardLayout title="Reservations" :user="user">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Link :href="route('admin.reservations.arrivals')"
            ...
            <Link :href="route('admin.reservations.departures')"
                  class="rounded-lg p-4 transition-colors border"
                  :style="{ backgroundColor: themeColors.card, borderColor: themeColors.border }"
                  @mouseenter="$event.currentTarget.style.backgroundColor = themeColors.hover"
                  @mouseleave="$event.currentTarget.style.backgroundColor = themeColors.card">
            ...
            <Link :href="route('admin.room-assignment')"
                  class="rounded-lg p-4 transition-colors border"
                  :style="{ backgroundColor: themeColors.card, borderColor: themeColors.border }"
                  @mouseenter="$event.currentTarget.style.backgroundColor = themeColors.hover"
                  @mouseleave="$event.currentTarget.style.backgroundColor = themeColors.card">
                    ...
                    <tbody>
                        <tr v-for="reservation in filteredReservations" :key="reservation.id"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <Link :href="route('admin.reservations.show', reservation.id)" class="hover:opacity-80 transition-opacity" :style="{ color: themeColors.primary }">View</Link>
                                    <Link :href="route('admin.reservations.edit', reservation.id)" class="hover:opacity-80 transition-opacity" :style="{ color: themeColors.success }">Edit</Link>
...
const checkIn = (reservation) => router.visit(`/admin/checkin?reservation_id=${reservation.id}`)
const checkOut = (reservation) => router.visit(`/admin/checkout?reservation_id=${reservation.id}`)
</script>
