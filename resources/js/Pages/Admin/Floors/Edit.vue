<template>
    <DashboardLayout title="Edit Floor" :user="user" :navigation="navigation">
        <div class="bg-kotel-dark border border-kotel-yellow/30 rounded-lg p-6">
            <h1 class="text-2xl font-bold text-kotel-yellow mb-6">Edit Floor</h1>
...
const form = useForm({
    ...
    is_active: props.floor.is_active,
    sort_order: props.floor.sort_order || 0,
})

const submit = () => {
    form.put(route('admin.floors.update', props.floor.id))
}
</script>
