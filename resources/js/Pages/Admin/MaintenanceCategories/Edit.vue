<template>
    <DashboardLayout title="Edit Maintenance Category">
        <div class="shadow rounded-lg p-6"
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold mb-1" :style="{ color: themeColors.textPrimary }">Edit Maintenance Category</h1>
                    <p class="text-sm" :style="{ color: themeColors.textSecondary }">Update category details.</p>
                </div>
...
const form = useForm({
    ...
    icon: props.category.icon || 'wrench',
    sort_order: props.category.sort_order || 0,
    is_active: props.category.is_active
})

const submitForm = () => {
    form.put(route(`${props.routePrefix}.maintenance-categories.update`, props.category.id))
}
</script>
