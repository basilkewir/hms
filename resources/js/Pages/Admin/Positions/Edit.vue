<template>
    <DashboardLayout title="Edit Position">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold mb-2"
                        :style="{ color: themeColors.textPrimary }">Edit Position</h1>
                    <p class="mt-2"
                       :style="{ color: themeColors.textSecondary }">Update position information.</p>
                </div>
