<template>
    <DashboardLayout title="Create Bed Type">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold mb-2"
                        :style="{ color: themeColors.textPrimary }">Create New Bed Type</h1>
                    <p class="mt-2"
                       :style="{ color: themeColors.textSecondary }">Add a new bed type to the hotel inventory.</p>
                </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t"
                    ...
                    <button type="submit" :disabled="form.processing" 
                        ...
                        {{ form.processing ? 'Creating...' : 'Create Bed Type' }}
                    </button>
                </div>
            </form>
        </div>
...
const submit = () => {
    form.post(route('admin.bed-types.store'))
}
</script>
