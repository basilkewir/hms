                        ...
                        <div v-for="reservation in pendingReservations" :key="reservation.id"
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <button @click.stop="selectReservation(reservation)"
                                        class="ml-4 px-3 py-1 text-sm rounded-md transition-colors font-medium text-white"
                                        :style="{ 
                                            backgroundColor: themeColors.primary,
                                        }"
                                        @mouseenter="$event.target.style.backgroundColor = themeColors.hover"
                        ...
                        <div v-for="room in filteredRooms" :key="room.id"
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button @click.stop="assignRoom(room)"
                                        ...
                                        class="ml-4 px-3 py-1 text-sm rounded-md transition-colors font-medium text-white disabled:opacity-50 disabled:cursor-not-allowed"
                                        :style="{ 
...
const assignRoom = (room) => {
    ...
    if (confirm(`Assign Room ${room.room_number} to ${selectedReservation.value.guest?.full_name}?`)) {
        router.post(route('front-desk.room-assignment.assign'), {
