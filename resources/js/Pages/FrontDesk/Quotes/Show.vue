...
const convertToInvoice = () => {
    if (confirm(`Convert quote #${props.quote.quote_number} to invoice? You will be redirected to the invoices page.`)) {
        router.post(route('front-desk.quotes.convert', props.quote.id))
    }
}
