...
const adminTutorial = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Amenities: attach amenities to a Room Type (Wi-Fi, balcony, sea view, jacuzzi…). These appear on booking confirmations and reports.',
...
const managerTutorial = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Amenities: manage the amenity list (Wi-Fi, sea view, balcony, jacuzzi, safe…) and attach them to room types. They display on booking confirmations.',
