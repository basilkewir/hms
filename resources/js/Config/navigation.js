      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: '⚡ Quick Check-In',  routeName: 'admin.quick-checkin' },
            { label: '🔑 Check-ins',       routeName: 'admin.checkin' },
            { label: '🔓 Check-outs',      routeName: 'admin.checkout' },
            { label: '👥 Today\'s Guests',  href: '/admin/checkin/today-guests' },
            { label: '🚔 Police Report',    href: '/admin/checkin/police-report' },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: '⚡ Quick Check-In',    routeName: 'manager.quick-checkin' },
            { label: '🔑 Check In',          routeName: 'manager.checkin' },
            { label: '🔓 Check Out',         routeName: 'manager.checkout' },
            { label: '👥 Today\'s Guests',    href: '/manager/checkin/today-guests' },
            { label: '🚔 Police Report',      href: '/manager/checkin/police-report' },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: '📈 TRevPAR',           routeName: 'manager.reports.trevpar' },
            { label: '🧾 Incidentals Analysis', routeName: 'manager.reports.incidentals' },
            { label: '🛠️ Damage Frequency',  routeName: 'manager.reports.damage-frequency' },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: 'Departmental Revenue', routeName: 'accountant.reports.departmental-revenue' },
            { label: 'Service Charge Distribution', routeName: 'accountant.reports.service-charge-distribution' },
            { label: 'Tax Reconciliation', routeName: 'accountant.reports.tax-reconciliation' },
            { label: 'Aging A/R', routeName: 'accountant.reports.aging-ar' },
            { label: 'Night Audit', routeName: 'accountant.reports.night-audit' },
            { label: 'Gratuity', routeName: 'accountant.reports.gratuity' },
            { label: 'Incidentals Analysis', routeName: 'accountant.reports.incidentals' },
            { label: 'Damage Frequency', routeName: 'accountant.reports.damage-frequency' },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: 'Quick Check-In', routeName: 'front-desk.quick-checkin' },
            { label: 'Check-ins',    routeName: 'front-desk.checkin' },
            { label: 'Check-outs',   routeName: 'front-desk.checkout' },
            { label: '🚔 Police Report', href: '/front-desk/checkin/police-report' },
          ],
        },
        {
          id: 'frontdesk-rooms',
