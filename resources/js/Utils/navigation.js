    ...
    const allNavigationItems = [
        ...
        // ==================== OPERATIONS ====================
        {
            ...
            children: [
                ...
                { name: 'Room Status',        href: `/${normalizedRole}/rooms/status`,       permission: 'view_rooms',   roles: ['manager'] },
        ...
        // ==================== ROOM / PROPERTY MANAGEMENT ====================
        {
            ...
            children: [
                ...
                { name: 'Room Status',        href: isAdmin ? '/admin/rooms/status'   : `/${normalizedRole}/rooms/status`,       permission: 'view_rooms',   roles: ['admin'] },
