...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_preferences', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100067')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->string('preference_type'); // preferred_time, preferred_day, preferred_season, etc.
