...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_settings', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100059')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->string('setting_key'); // default_price, min_booking_days, max_booking_days, etc.
