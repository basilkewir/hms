...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_preferences', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100107')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->string('preference_key'); // preferred_time, preferred_date, etc.
