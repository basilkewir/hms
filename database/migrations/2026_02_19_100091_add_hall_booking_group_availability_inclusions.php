...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_inclusions', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100091')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->string('inclusion_type'); // catering, equipment, staff, etc.
