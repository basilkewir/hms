...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_exceptions', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100117')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->date('exception_date');
            $table->string('exception_type'); // closed, limited_availability, etc.
