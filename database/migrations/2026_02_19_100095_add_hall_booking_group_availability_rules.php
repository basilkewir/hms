...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('hall_booking_group_availability_rules', function (Blueprint $table) {
            ...
            $table->foreign('group_booking_id', 'fk_gbid_100095')->references('id')->on('group_bookings')->onDelete('cascade');
            $table->string('rule_type'); // minimum_booking_days, maximum_booking_days, booking_window, etc.
