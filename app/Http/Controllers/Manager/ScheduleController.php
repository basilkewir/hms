...
class ScheduleController extends Controller
{
    public function index(Request $request)
    {
        ...
        \Log::info('Manager Staff users found for scheduling: ' . $staffUsers->count());
        \Log::info('Manager Staff users data: ' . json_encode($staffUsers->toArray()));
    ...
    public function print(Request $request)
    {
        ...
        return Inertia::render('Manager/Schedules/Print', [
            'user' => auth()->user()->load('roles'),
    ...
    public function generateSchedule()
    {
        ...
        return redirect()->route('manager.staff.schedules')
